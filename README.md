...
**v2.0 多智能体架构**: 系统已从线性流水线升级为基于 LangGraph 的 Supervisor-Worker 多智能体系统！

### 新架构特点

- ✅ **智能路由**: Supervisor 基于 LLM 动态决策下一步执行
- ✅ **Critic Loop**: 自动检测高风险场景并触发自我修正
- ✅ **自适应**: 根据风险等级动态调整检验策略
- ✅ **自愈性**: 错误自动降级处理，无需人工干预
- ✅ **可观测**: 完整的执行日志和智能体反思记录
...
**快速开始**: 参见 [SWARM_USAGE.md](SWARM_USAGE.md) 和 [examples/quick_start_swarm.py](examples/quick_start_swarm.py)

---

## 系统架构 (Legacy)

传统线性流水线架构（`MainAgent`）仍然可用：
